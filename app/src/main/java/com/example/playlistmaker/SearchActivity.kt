...
class SearchActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val trackAdapter = TrackAdapter(
            listOf(
                Track(
                    "Smells Like Teen Spiritttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt",
                    "Nirvanaggggggggggggggggggggggggggggggggggggggggggggggg",
                    "5:01",
